---
description: A breadcrumb consists of a list of links to the parent pages of the current page in hierarchical order.
publishedAt: 2022-06-24
---

# breadcrumb

{description} It helps users find their place within a website or web
